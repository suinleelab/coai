...
void Config::GetMembersFromString(const std::unordered_map<std::string, std::string>& params) {
  ...
  if (GetString(params, "cegb_feature_groups", &tmp_str)) {
    cegb_feature_groups = Common::StringToArray<int32_t>(tmp_str, ',');
  }
...
std::string Config::SaveMembersToString() const {
  ...
  str_buf << "[cegb_feature_groups: " << Common::Join(cegb_feature_groups, ",") << "]\n";
